...
class PeftModelWrapper:
    def __init__(
        ...
        self.config = config
        self.base_model_get_nb_trainable_parameters = (
            base_model_get_nb_trainable_parameters
        )
    ...
    def get_nb_trainable_parameters(self) -> Tuple[int, int]:
        ...
        classifier: xLoRAClassifier = self.model.internal_xlora_classifier  # type: ignore
        (
            xlora_trainable_params,
            xlora_all_param,
        ) = classifier.get_nb_trainable_parameters()
